...
<div class="container">
  <nav aria-label="breadcrumb custom-cr">
    <ol class="breadcrumb crumb-custom">
        ...
        <li class="breadcrumb-item active" aria-current="page">Редактирование акции</li>
    </ol>
</nav>
  <form action="/cp_edit_maction/{{$item->id}}" method="POST" enctype="multipart/form-data">
    @csrf
    <img src="/storage/mactions/{{$item->image}}" style="object-fit: cover;height:130px;" class="d-block w-100" alt="...">
