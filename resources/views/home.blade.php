...
<div class="container">
    <div class="row">
            ...
            <div class="col">
                <a href="{{$collection->href}}" class="">
                    <div class="rounded-3 divimg">
                        <img class="img-custom rounded-3" style="object-fit: cover;height:133px;" src="/storage/collections/{{$collection->image}}" alt="">
                    </div>
                </a>
            </div>
            @endforeach
        ...
        <div class="row g-2 row-cols-2 mt-0 mb-3 px-3">
